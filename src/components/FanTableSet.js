...
import SetFanIndex from './FanIndexUpdater';
      ...
      <div className="fantableset">
        ...
        <Table striped bordered hover>              
            ...
            <tbody>      
                ...
                <td>1</td>
                <td>Heating Fan</td>
                <td><SetFanIndex fanID = "f0" fan_indexes = {fan_indexes}/></td>
                <td>{FanState1}</td>
                </tr>
                <tr>
                <td>2</td>
                <td>Convection Fan</td>
                <td><SetFanIndex fanID = "f1" fan_indexes = {fan_indexes}/></td> 
                <td>{FanState2}</td>
                </tr>          
                <tr>
                <td>3</td>
                <td>Pi Fan</td>
                <td><SetFanIndex fanID = "f2" fan_indexes = {fan_indexes}/></td>
                <td>{FanState3}</td>
                </tr>
            </tbody>
        </Table>
