...
var socket = socketio.connect('http://192.168.0.31:5000');
...
function App() {
  ...
  var selectedvalue1 = '2';
  function getDropDownVal1(cur_val) {
    console.log(cur_val);
    var selectedvalue1 = cur_val;   
          ...
          <tbody>          
            <tr>
              ...
              <Dropdown>
                ...
                <Dropdown.Menu>
                  <Dropdown.Item onClick={() => getDropDownVal1(1)}>1</Dropdown.Item>
                  <Dropdown.Item onClick={() => getDropDownVal1(2)}>2</Dropdown.Item>
                  <Dropdown.Item onClick={() => getDropDownVal1(3)}>3</Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
              </td>
